...
(
	...
	Pad[-1.575mm 0.95mm -1.125mm 0.95mm 0.6mm 0.5mm  0.74mm "2" "2" "square"]
	Pad[1.125mm 0.0mm 1.575mm 0.0mm 0.6mm 0.5mm  0.74mm "3" "3" "square"]
	...
	Attribute("description" "IC, SOT-23, 3 pin")
	)
